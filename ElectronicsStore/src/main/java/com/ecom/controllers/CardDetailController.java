...
import com.ecom.services.CardDetailService;
...
public class CardDetailController {
	    ...
	    public String CardDetailPost(@PathVariable(value ="cartId") int cartId, @Valid @ModelAttribute("carddetail") CardDetails cardDetail, BindingResult result
